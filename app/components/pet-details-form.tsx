...
//         }}>
//           {options.map((option) => (
//             <div key={option} onClick={() => handleDropdownSelect(field, option)} style={buttonStyle}>{option}</div>
//           ))}
//         </div>
//       )}
//     </div>
...
/////////////////  im leaving all of the above if I decide to change the required messeage of the animal kind field.
/////////////////  the above makes it not required.
