  ...
  const DynamicLostProfile = dynamic(() => import('./pages/lostprofile'), { ssr: false });
  ...
  const ClientSideApp = dynamic(() => Promise.resolve(App), { ssr: false });
